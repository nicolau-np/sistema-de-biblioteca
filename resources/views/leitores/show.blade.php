                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <div class="column mb-2"><span>Nome:</span> {{ $livro->titulo }}</div>
                            <div class="column mb-2"><span>Nº de B.I:</span> {{ $livro->numero_de_paginas }}</div>
                            <div class="column mb-2"><span>Gênero:</span> {{ $livro->editora }}</div>
