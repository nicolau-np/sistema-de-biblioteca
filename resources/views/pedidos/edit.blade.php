                            ...
                            <div class="row">
                                    ...
                                    <select name="livro_id" class="form-select select2">
                                        ...
                                        @foreach ($livros as $livro)
                                            <option value="{{ $livro->id }}"
                                                {{ old('livro_id', $pedido->livro_id) == $livro->id ? 'selected' : null }}>{{ $livro->titulo }}
                                    ...
                                    <select name="leitor_id" class="form-select select2">
                                        ...
                                        @foreach ($leitores as $leitor)
                                            <option value="{{ $leitor->id }}"
                                                {{ old('leitor_id', $pedido->leitor_id) == $leitor->id ? 'selected' : null }}>
                                                {{ $leitor->nome }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-3 mb-4">
                                    ...
                                    <input type="date" name="data_do_pedido" class="form-control"
                                        value="{{ old('data_do_pedido', $pedido->data_do_pedido) }}" />
                                ...
                                <div class="col-md-3 mb-4">
                                    ...
                                    <input type="date" name="data_de_devolucao" class="form-control"
                                        value="{{ old('data_de_devolucao', $pedido->data_de_devolucao) }}" />
